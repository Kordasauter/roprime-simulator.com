...
{ 
	...
	{
		wSPC_VIT += Math.floor(SU_LUK / 12)
		wSPC_LUK += Math.floor(SU_LUK / 12)
	}
	if(EquipNumSearch(2893) && n_A_card[card_loc_SHOES] == 423)//Nameless Swordsman's Boots + Boss Egnigem Card
	{
		wSPC_STR += 20 * Math.floor(n_A_SHOES_DEF_PLUS/3)
	}
	if(EquipNumSearch(2895) && n_A_card[card_loc_SHOES] == 228)//Applause Sandals + Amon Ra Card
	{
		wSPC_STR += 3 * n_A_SHOES_DEF_PLUS
		wSPC_AGI += 3 * n_A_SHOES_DEF_PLUS
		wSPC_VIT += 3 * n_A_SHOES_DEF_PLUS
		wSPC_INT += 3 * n_A_SHOES_DEF_PLUS
		wSPC_DEX += 3 * n_A_SHOES_DEF_PLUS
		wSPC_LUK += 3 * n_A_SHOES_DEF_PLUS
	}
	if(EquipNumSearch(3181))// Valkyrie's Knife (Novice)
	{
		wSPC_DEX = -1 * Math.floor(SU_DEX / 10) * n_A_Weapon_ATKplus
	}
...
// 229 = Star Emperor
// 230 = Soul Reaper
// 300 = AB Cls + SOR Cls + Star Emperor
// 301 = Bar & Dan
// >1000 -> Rebi & Sub
// >2000 -> 3rd  & Sub
...
JobEquipItemOBJ = [
/* Nov */[0, 2,    50, 90, 96,100, 146, 148, 999],
/* Swo */[0, 2, 1, 3, 51,101, 70, 71, 72, 74, 75, 78, 83, 84, 85, 86, 87, 90, 91, 93, 96, 97, 147, 148, 999],
...
/* Mer */[0, 2, 1, 3, 56,106, 70, 71, 72, 73, 74, 75, 78, 83, 84, 85, 86, 90, 91, 96, 97, 147, 148, 999],

/* Kni */[0, 2, 1, 3, 51, 61,107, 70, 71, 72, 74, 75, 78, 79, 83, 84, 85, 86, 87, 90, 91, 93, 96, 97, 147, 148, 999],
/* Ass */[0, 2, 1, 3, 52, 62,108, 72, 74, 75, 78, 79, 81, 83, 84, 85, 90, 91, 96, 97, 147, 148, 999],
...
/* Bla */[0, 2, 1, 3, 56, 66,112, 70, 71, 72, 73, 74, 75, 78, 79, 83, 84, 85, 86, 90, 91, 96, 97, 147, 148, 999],

/* Cru */[0, 2, 1, 3, 51, 61,113, 70, 71, 72, 74, 75, 78, 79, 83, 84, 85, 86, 87, 90, 91, 93, 96, 97, 147, 148, 999],
...
/* Bar */[0, 2, 1, 3, 54, 64,116, 74, 75, 76, 79, 83, 89, 147, 301, 999],
/* Dan */[0, 2, 1, 3, 54, 64,117, 74, 75, 76, 79, 83, 89, 147, 301, 999],
/* Sag */[0, 2, 1, 3, 55, 65,118, 71, 77, 79, 89, 95, 97,  146, 999],
/* Alc */[0, 2, 1, 3, 56, 66,119, 70, 71, 72, 73, 74, 75, 78, 79, 83, 84, 85, 86, 90, 91, 96, 97, 147, 148, 999],

/* Sno */[0, 2,    50, 90, 96, 120, 148, 999],
/* Lor */[0, 2, 1, 3, 51, 61,107,121, 70, 71, 72, 74, 75, 78, 79, 82, 83, 84, 85, 86, 87, 90, 91, 93, 96, 97, 147, 148, 999],
/* ASX */[0, 2, 1, 3, 52, 62,108,122, 72, 74, 75, 78, 79, 81, 82, 83, 84, 85, 90, 91, 96, 97, 147, 148, 999],
...
/* Mas */[0, 2, 1, 3, 56, 66,112,126, 70, 71, 72, 73, 74, 75, 78, 79, 82, 83, 84, 85, 86, 90, 91, 96, 97, 147, 148, 148, 999],
...
/* Bio */[0, 2, 1, 3, 56, 66,119,133, 70, 71, 72, 73, 74, 75, 78, 79, 82, 83, 84, 85, 86, 90, 91, 96, 97, 147, 148, 999],

/* HNo */[0, 2,    50, 90, 96,100, 146, 148, 999],
/* HSw */[0, 2, 1, 3, 51,101, 70, 71, 72, 74, 75, 78, 83, 84, 85, 86, 87, 90, 91, 93, 96, 97, 147, 148, 999],
/* HTh */[0, 2, 1, 3, 52,102, 72, 74, 75, 78, 80, 83, 84, 85, 90, 91, 96, 97, 147, 148, 999],
...
/* HMe */[0, 2, 1, 3, 56,106, 70, 71, 72, 73, 74, 75, 78, 83, 84, 85, 86, 90, 91, 96, 97, 147, 148, 999],
...
/* Run */[0, 2, 1, 3, 51, 61,107,207,121, 70, 71, 72, 74, 75, 78, 79, 82, 83, 84, 85, 86, 87, 90, 91, 93, 96, 97, 147, 148, 226, 999],
/* Run */[0, 2, 1, 3, 51, 61,107,207,121, 70, 71, 72, 74, 75, 78, 79, 82, 83, 84, 85, 86, 87, 90, 91, 93, 96, 97, 147, 148, 226, 999],
/* GlX */[0, 2, 1, 3, 52, 62,108,208,122, 72, 74, 75, 78, 79, 81, 82, 83, 84, 85, 90, 91, 96, 97, 147, 226, 148, 999],
/* GlX */[0, 2, 1, 3, 52, 62,108,208,122, 72, 74, 75, 78, 79, 81, 82, 83, 84, 85, 90, 91, 96, 97, 147, 226, 148, 999],
/* ABi */[0, 2, 1, 3, 53, 63,109,209,123, 71, 73, 74, 77, 78, 79, 81, 82, 85, 89, 92, 94, 95,  146, 226, 228, 300, 999], //ADDED 94
/* ABi */[0, 2, 1, 3, 53, 63,109,209,123, 71, 73, 74, 77, 78, 79, 81, 82, 85, 89, 92, 94, 95,  146, 226, 228, 300, 999], //ADDED 94
...
/* WLo */[0, 2, 1, 3, 55, 65,111,211,125, 71, 77, 79, 82, 89, 94, 97, 146, 226, 228, 999], //ADDED 94
/* Mec */[0, 2, 1, 3, 56, 66,112,212,126, 70, 71, 72, 73, 74, 75, 78, 79, 82, 83, 84, 85, 86, 90, 91, 92, 96, 97, 147, 148, 226, 999],
/* Mec */[0, 2, 1, 3, 56, 66,112,212,126, 70, 71, 72, 73, 74, 75, 78, 79, 82, 83, 84, 85, 86, 90, 91, 92, 96, 97, 147, 148, 226, 999],

/* RGu */[0, 2, 1, 3, 51, 61,113,213,127, 70, 71, 72, 74, 75, 78, 79, 82, 83, 84, 85, 86, 87, 90, 91, 93, 96, 97, 147, 148, 226, 999],
/* RGu */[0, 2, 1, 3, 51, 61,113,213,127, 70, 71, 72, 74, 75, 78, 79, 82, 83, 84, 85, 86, 87, 90, 91, 93, 96, 97, 147, 148, 226, 999],
...
/* Wan */[0, 2, 1, 3, 54, 64,117,217,131, 74, 75, 76, 79, 82, 83, 89, 147, 226, 227, 999],
/* Sor */[0, 2, 1, 3, 55, 65,118,218,132, 71, 77, 79, 82, 89, 95, 97, 146, 226, 300, 999],
/* Sor */[0, 2, 1, 3, 55, 65,118,218,132, 71, 77, 79, 82, 89, 95, 97, 146, 226, 300, 999],
/* Gen */[0, 2, 1, 3, 56, 66,119,219,133, 70, 71, 72, 73, 74, 75, 78, 79, 82, 83, 84, 85, 86, 90, 91, 92, 96, 97, 147, 148, 226, 999],
/* Gen */[0, 2, 1, 3, 56, 66,119,219,133, 70, 71, 72, 73, 74, 75, 78, 79, 82, 83, 84, 85, 86, 90, 91, 92, 96, 97, 147, 148, 226, 999],
/* Obo */[0, 2, 1, 3,144, 58, 52, 91, 97, 221, 225, 226, 999],
/* Eno */[0, 2, 50, 90, 120, 148, 220, 226, 228, 999],
/* Reb */[0, 2, 1, 3, 145,  59,  83, 222, 225, 226, 999],
/* Sum */[0, 1, 224, 226, 999],
/* Ste */[0, 2, 1, 3,142, 79, 83, 84, 85, 86, 87, 91, 93, 95,  147, 223, 225, 226, 229, 300, 999],
