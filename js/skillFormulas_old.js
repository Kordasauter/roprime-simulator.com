...
function CalcSkillDamage()
{
	...
	if ( n_A_ActiveSkill == w_ActS[iw] )
	{
		...
		else if(n_A_ActiveSkill==skill_KN_BRANDISH_SPEAR)
		{
			...
			w_SkillMod += 3.0 + n_A_ActiveSkillLV ;//prime
			w_SkillMod += n_A_STR * 5;//add str to calc ? test
		...
		else if(n_A_ActiveSkill==skill_MO_RAGING_THRUST)
		{
			...
			w_SkillMod += 3.5+n_A_ActiveSkillLV *1.5;//prime
			w_SkillMod += n_A_STR * 5;//prime
			fixedCastTime *= 0.0;
			variableCastTime *= 0.0;
			n_Delay[ksDelayA] = 1.0;
			n_Delay[ksDelayASPD] = 0.1;
		...
		else if ( n_A_ActiveSkill == skill_AX_METEOR_ASSAULT )
		{
			...
			w_SkillMod = 2 + (n_A_ActiveSkillLV * 1.2);//prime
			w_SkillMod = w_SkillMod + (n_A_STR * 5);//prime
			w_SkillMod = w_SkillMod * (n_A_BaseLV/100);//prime
