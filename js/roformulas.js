...
function calcHP()
{
	...
	{ // not 3rd class
		...
		if (n_A_JOB === cls_KAGOB) {
			...
			let KagobHP = new Array(4250,4305,//99-100
									...
									8860,9015,9170,9325,9480,9635,9790,9945,10100,16397,//161-170
									10410,10565,10720,10875,11030,11185,11340,11495,11650,11805,//171-180
									11960,12115,12270,12425,12580,12735,12890,13045,13200,13355,//181-190
									13510,13665,13820,13975,14130,14285,14440,14595,14750,14905);//191-200
...
//Enchant
	if(EnchNumSearch( 846 ))//Special LUK = 286
	{
		if(n_A_SHOULDER_DEF_PLUS >8)
		{
			hpMultiplier += 1;
...
//Enchant
	if(EnchNumSearch( 843 ))//Special VIT = 283
	{
		if(n_A_SHOULDER_DEF_PLUS >8)
		{
			spMultiplier += 1;
