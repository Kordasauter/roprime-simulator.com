function setMenu() {
  ...
  str += '<div class="sidebar-heading">Last update : 05/02/2026</div>';
  ...
  if (index == "contact.html") str += '<li class="nav-item active">';
  else str += '<li class="nav-item">';
  ...
  str += '<li class="nav-item">';
  str +=
    '<a class="nav-link" href="https://github.com/Kordasauter/roprime-simulator.com">';
  ...
  if (index == "about.html") str += '<li class="nav-item active">';
  else str += '<li class="nav-item">';
