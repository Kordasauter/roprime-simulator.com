...
function ClickGarment( garment )
{
	//clean enchant list
	var len = formElements["A_FAW_enchant1"].length;
	for ( var i = 0; i < len ; i++ )
	{
		formElements["A_FAW_enchant1"].options[0] = null;
	}
	len = formElements["A_FAW_enchant3"].length;
	for ( var i = 0; i < len ; i++ )
	{
		formElements["A_FAW_enchant2"].options[0] = null;
		formElements["A_FAW_enchant3"].options[0] = null;
	}
	
	if( garment == 1545 || EquipNumSearch( 1545 ))
	{
		for ( var i = 0; EnchantListOBJ[3][i] != "NULL"; i++ )
		{
			formElements["A_FAW_enchant3"].options[i] = new Option(EnchantOBJ[EnchantListOBJ[3][i]][1],EnchantOBJ[EnchantListOBJ[3][i]][0]);
		}
		formElements["A_FAW_enchant3"].disabled = false;
		if(n_A_SHOULDER_DEF_PLUS > 6)
		{
			for ( var i = 0; EnchantListOBJ[3][i] != "NULL"; i++ )
			{
				formElements["A_FAW_enchant2"].options[i] = new Option(EnchantOBJ[EnchantListOBJ[3][i]][1],EnchantOBJ[EnchantListOBJ[3][i]][0]);
			}
			formElements["A_FAW_enchant2"].disabled = false;
			if(n_A_SHOULDER_DEF_PLUS > 8)
			{
				for ( var i = 0; EnchantListOBJ[2][i] != "NULL"; i++ )
				{
						formElements["A_FAW_enchant1"].options[i] = new Option(EnchantOBJ[EnchantListOBJ[2][i]][1],EnchantOBJ[EnchantListOBJ[2][i]][0]);
				}
				formElements["A_FAW_enchant1"].disabled = false;
			}
			else
			{
				for ( var i = 0; EnchantListOBJ[0][i] != "NULL"; i++ )
				{
						formElements["A_FAW_enchant1"].options[i] = new Option(EnchantOBJ[EnchantListOBJ[0][i]][1],EnchantOBJ[EnchantListOBJ[0][i]][0]);
				}
				formElements["A_FAW_enchant1"].disabled = true;
			}
		}
		else
		{
			for ( var i = 0; EnchantListOBJ[0][i] != "NULL"; i++ )
			{
				formElements["A_FAW_enchant2"].options[i] = new Option(EnchantOBJ[EnchantListOBJ[0][i]][1],EnchantOBJ[EnchantListOBJ[0][i]][0]);
				formElements["A_FAW_enchant1"].options[i] = new Option(EnchantOBJ[EnchantListOBJ[0][i]][1],EnchantOBJ[EnchantListOBJ[0][i]][0]);
			}
			formElements["A_FAW_enchant2"].disabled = true;
			formElements["A_FAW_enchant1"].disabled = true;
		}
	}
	else
		...
		for ( var i = 0; EnchantListOBJ[0][i] != "NULL"; i++ )
			{
					formElements["A_FAW_enchant1"].options[i] = new Option(EnchantOBJ[EnchantListOBJ[0][i]][1],EnchantOBJ[EnchantListOBJ[0][i]][0]);
					formElements["A_FAW_enchant2"].options[i] = new Option(EnchantOBJ[EnchantListOBJ[0][i]][1],EnchantOBJ[EnchantListOBJ[0][i]][0]);
					formElements["A_FAW_enchant3"].options[i] = new Option(EnchantOBJ[EnchantListOBJ[0][i]][1],EnchantOBJ[EnchantListOBJ[0][i]][0]);
			}
		formElements["A_FAW_enchant1"].disabled = true;
		formElements["A_FAW_enchant2"].disabled = true;
		formElements["A_FAW_enchant3"].disabled = true;
