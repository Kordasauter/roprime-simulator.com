...
bon_DEFIGN_RC_NON_BOSS = 293;//%def reduction
bon_MDEFIGN_RC_NON_BOSS = 294;
...
bon_MDMG_ELE_SHADOW = 357;
bon_MDMG_ELE_GHOST = 358;
bon_MDMG_ELE_UNDEAD = 359;

bon_DEFIGN_SIZ_SMALL = 360;//%def reduction
bon_DEFIGN_SIZ_MEDIUM = 361;
bon_DEFIGN_SIZ_LARGE = 362;
bon_MDEFIGN_SIZ_SMALL = 363;
bon_MDEFIGN_SIZ_MEDIUM = 364;
bon_MDEFIGN_SIZ_LARGE = 365;
...
ench_ASPD = ench_MAGIC + 10;
ench_ASPD_MUL = ench_ASPD + 10;
...
ench_CASTDELAY_SARAH = ench_FATAL + 10;
ench_CASTDELAY = ench_CASTDELAY_SARAH + 10;
...
ench_ARMOR_ELE = ench_HEAL_MUL + 21;
// ench_RED_ELE_NEUTRAL = ench_ARMOR_ELE + 10;
ench_RED_ELE_NEUTRAL = ench_ARMOR_ELE + 9;
...
ench_RED_ELE_SHADOW = ench_RED_ELE_HOLY + 30;
...
ench_DMG_ELE_NEUTRAL = ench_RED_BOSS + 30;
ench_DMG_ELE_WATER = ench_DMG_ELE_NEUTRAL + 30;
ench_DMG_ELE_EARTH = ench_DMG_ELE_WATER + 30;
ench_DMG_ELE_FIRE = ench_DMG_ELE_EARTH + 30;
ench_DMG_ELE_WIND = ench_DMG_ELE_FIRE + 30;
ench_DMG_ELE_POISON = ench_DMG_ELE_WIND + 30;
ench_DMG_ELE_HOLY = ench_DMG_ELE_POISON + 30;
ench_DMG_ELE_SHADOW = ench_DMG_ELE_HOLY + 30;
ench_DMG_ELE_DARK = ench_DMG_ELE_HOLY + 30;
ench_DMG_ELE_GHOST = ench_DMG_ELE_SHADOW + 30;
ench_DMG_ELE_UNDEAD = ench_DMG_ELE_GHOST + 30;
ench_DMG_RC_FORMLESS = ench_DMG_ELE_UNDEAD + 30;
ench_DMG_RC_UNDEAD = ench_DMG_RC_FORMLESS + 30;
ench_DMG_RC_BRUTE = ench_DMG_RC_UNDEAD + 30;
ench_DMG_RC_PLANT = ench_DMG_RC_BRUTE + 30;
ench_DMG_RC_INSECT = ench_DMG_RC_PLANT + 30;
ench_DMG_RC_FISH = ench_DMG_RC_INSECT + 30;
ench_DMG_RC_DEMON = ench_DMG_RC_FISH + 30;
ench_DMG_RC_DEMI_HUMAN = ench_DMG_RC_DEMON + 30;
ench_DMG_RC_ANGEL = ench_DMG_RC_DEMI_HUMAN + 30;
ench_DMG_RC_DRAGON = ench_DMG_RC_ANGEL + 30;
ench_DMG_BOSS = ench_DMG_RC_DRAGON + 30;
ench_DEFIGN_RC_FORMLESS = ench_DMG_BOSS + 30;
ench_DEFIGN_RC_UNDEAD = ench_DEFIGN_RC_FORMLESS + 100;
ench_DEFIGN_RC_BRUTE = ench_DEFIGN_RC_UNDEAD + 100;
ench_DEFIGN_RC_PLANT = ench_DEFIGN_RC_BRUTE + 100;
ench_DEFIGN_RC_INSECT = ench_DEFIGN_RC_PLANT + 100;
ench_DEFIGN_RC_FISH = ench_DEFIGN_RC_INSECT + 100;
ench_DEFIGN_RC_DEMON = ench_DEFIGN_RC_FISH + 100;
ench_DEFIGN_RC_DEMI_HUMAN = ench_DEFIGN_RC_DEMON + 100;
ench_DEFIGN_RC_ANGEL = ench_DEFIGN_RC_DEMI_HUMAN + 100;
ench_DEFIGN_RC_DRAGON = ench_DEFIGN_RC_ANGEL + 100;
ench_DEFIGN_BOSS = ench_DEFIGN_RC_DRAGON + 100;
ench_MDMG_ELE_NEUTRAL = ench_DEFIGN_BOSS + 100;
ench_MDMG_ELE_WATER = ench_MDMG_ELE_NEUTRAL + 30;
ench_MDMG_ELE_EARTH = ench_MDMG_ELE_WATER + 30;
ench_MDMG_ELE_FIRE = ench_MDMG_ELE_EARTH + 30;
ench_MDMG_ELE_WIND = ench_MDMG_ELE_FIRE + 30;
ench_MDMG_ELE_POISON = ench_MDMG_ELE_WIND + 30;
ench_MDMG_ELE_HOLY = ench_MDMG_ELE_POISON + 30;
ench_MDMG_ELE_SHADOW = ench_MDMG_ELE_HOLY + 30;
ench_MDMG_ELE_DARK = ench_MDMG_ELE_HOLY + 30;
ench_MDMG_ELE_GHOST = ench_MDMG_ELE_SHADOW + 30;
ench_MDMG_ELE_UNDEAD = ench_MDMG_ELE_GHOST + 30;
ench_MDMG_RC_FORMLESS = ench_MDMG_ELE_UNDEAD + 30;
ench_MDMG_RC_UNDEAD = ench_MDMG_RC_FORMLESS + 30;
ench_MDMG_RC_BRUTE = ench_MDMG_RC_UNDEAD + 30;
ench_MDMG_RC_PLANT = ench_MDMG_RC_BRUTE + 30;
ench_MDMG_RC_INSECT = ench_MDMG_RC_PLANT + 30;
ench_MDMG_RC_FISH = ench_MDMG_RC_INSECT + 30;
ench_MDMG_RC_DEMON = ench_MDMG_RC_FISH + 30;
ench_MDMG_RC_DEMI_HUMAN = ench_MDMG_RC_DEMON + 30;
ench_MDMG_RC_ANGEL = ench_MDMG_RC_DEMI_HUMAN + 30;
ench_MDMG_RC_DRAGON = ench_MDMG_RC_ANGEL + 30;
ench_MDMG_BOSS = ench_MDMG_RC_DRAGON + 30;
ench_MDEFIGN_RC_FORMLESS = ench_MDMG_BOSS + 30;
ench_MDEFIGN_RC_UNDEAD = ench_MDEFIGN_RC_FORMLESS + 100;
ench_MDEFIGN_RC_BRUTE = ench_MDEFIGN_RC_UNDEAD + 100;
ench_MDEFIGN_RC_PLANT = ench_MDEFIGN_RC_BRUTE + 100;
ench_MDEFIGN_RC_INSECT = ench_MDEFIGN_RC_PLANT + 100;
ench_MDEFIGN_RC_FISH = ench_MDEFIGN_RC_INSECT + 100;
ench_MDEFIGN_RC_DEMON = ench_MDEFIGN_RC_FISH + 100;
ench_MDEFIGN_RC_DEMI_HUMAN = ench_MDEFIGN_RC_DEMON + 100;
ench_MDEFIGN_RC_ANGEL = ench_MDEFIGN_RC_DEMI_HUMAN + 100;
ench_MDEFIGN_RC_DRAGON = ench_MDEFIGN_RC_ANGEL + 100;
ench_MDEFIGN_BOSS = ench_MDEFIGN_RC_DRAGON + 100;
ench_METTLE = ench_MDEFIGN_BOSS + 100;
ench_TENACITY = ench_METTLE + 10;
ench_MASTER_ARCHER = ench_TENACITY + 10;
ench_ACUTE = ench_MASTER_ARCHER + 10;
ench_MAGIC_ESSENCE = ench_ACUTE + 10;
ench_AFFECTION = ench_MAGIC_ESSENCE + 10;
ench_ADAMANTINE = ench_AFFECTION + 10;
ench_RUNE_OF_STR = ench_ADAMANTINE + 10;
ench_RUNE_OF_AGI = ench_RUNE_OF_STR + 3;
ench_RUNE_OF_VIT = ench_RUNE_OF_AGI + 3;
...
ench_MOD_ORB_DEF = ench_MDMG_NON_BOSS + 30 +1;
ench_MOD_ORB_MDEF = ench_MOD_ORB_DEF + 1;
ench_MOD_ORB_ATK = ench_MOD_ORB_MDEF + 1;
ench_MOD_ORB_MATK = ench_MOD_ORB_ATK + 1;
ench_MOD_ORB_SHARPSHOOTER = ench_MOD_ORB_MATK + 1;
ench_MOD_ORB_SPEED = ench_MOD_ORB_SHARPSHOOTER + 1;
ench_MOD_ORB_CASTER = ench_MOD_ORB_SPEED + 1;
ench_MOD_ORB_CRITICAL = ench_MOD_ORB_CASTER + 1;
ench_MOD_ORB_HEALTH = ench_MOD_ORB_CRITICAL + 1;
ench_MOD_ORB_SPIRIT = ench_MOD_ORB_HEALTH + 1;
ench_MOD_ORB_HEAL = ench_MOD_ORB_SPIRIT + 1;
ench_MOD_ORB_HP_RECOVERY = ench_MOD_ORB_HEAL + 1;
ench_MOD_ORB_SP_RECOVERY = ench_MOD_ORB_HP_RECOVERY + 1;
ench_MOD_ORB_GLOBAL_DELAY = ench_MOD_ORB_SP_RECOVERY + 1;
ench_MOD_ORB_ABOVE_ALL = ench_MOD_ORB_GLOBAL_DELAY + 1;
ench_MOD_ORB_FIXED_CASTING = ench_MOD_ORB_ABOVE_ALL + 1;
ench_MOD_ORB_DRAIN_LIFE = ench_MOD_ORB_FIXED_CASTING + 1;
ench_MOD_ORB_MAGIC_HEALING = ench_MOD_ORB_DRAIN_LIFE + 1;
ench_MOD_ORB_DRAIN_SOUL = ench_MOD_ORB_MAGIC_HEALING + 1;
ench_MOD_ORB_MAGIC_SOUL = ench_MOD_ORB_DRAIN_SOUL + 1;
ench_MOD_ORB_UNLIMITED_VITALITY = ench_MOD_ORB_MAGIC_SOUL + 1;
ench_MOD_ORB_SPELL_BUSTER = ench_MOD_ORB_UNLIMITED_VITALITY + 1;
ench_MOD_ORB_FIERCE_SHOOTER = ench_MOD_ORB_SPELL_BUSTER + 1;
ench_MOD_ORB_OVERPOWER = ench_MOD_ORB_FIERCE_SHOOTER + 1;
ench_MOD_ORB_FATAL_FLASH = ench_MOD_ORB_OVERPOWER + 1;
ench_MOD_ORB_LUCKY_STRIKE = ench_MOD_ORB_FATAL_FLASH + 1;
...
ench_VANGUARD_FORCE = ench_INVISIBILITY + 1;//for other skills
ench_KINGS_GRACE = ench_VANGUARD_FORCE + 1;//placeholder
ench_skill3 = ench_KINGS_GRACE + 1;//placeholder
ench_skill4 = ench_skill3 + 1;//placeholder
ench_skill5 = ench_skill4 + 1;//placeholder
ench_skill6 = ench_skill5 + 1;//placeholder
ench_skill7 = ench_skill6 + 1;//placeholder
ench_skill8 = ench_skill7 + 1;//placeholder
ench_skill9 = ench_skill8 + 1;//placeholder
ench_SEIREN_MEMORY = ench_skill9 + 1;
ench_HOWARD_MEMORY = ench_SEIREN_MEMORY + 1;
ench_EREMES_MEMORY = ench_HOWARD_MEMORY + 1;
ench_KATHRYNE_MEMORY = ench_EREMES_MEMORY + 1;
ench_MARGARETHA_MEMORY = ench_KATHRYNE_MEMORY + 1;
ench_CECIL_MEMORY = ench_MARGARETHA_MEMORY + 1;
ench_RANDEL_MEMORY = ench_CECIL_MEMORY + 1;
ench_FLAMEL_MEMORY = ench_RANDEL_MEMORY + 1;
ench_GERTIE_MEMORY = ench_FLAMEL_MEMORY + 1;
ench_CELIA_MEMORY = ench_GERTIE_MEMORY + 1;
ench_CHEN_MEMORY = ench_CELIA_MEMORY + 1;
ench_TRENTINI_MEMORY = ench_CHEN_MEMORY + 1;
ench_ALPHOCCIO_MEMORY = ench_TRENTINI_MEMORY + 1;
ench_FLASH = ench_ALPHOCCIO_MEMORY + 1;
ench_STRONG = ench_FLASH + 1;
ench_THOUSAND_BOW = ench_STRONG + 1;
...
fl_SHOES = 64;
fl_SHADOW_ARMOR = 128;
fl_SHADOW_WEAPON = 256;
fl_SHADOW_SHIELD = 512;
fl_SHADOW_SHOES = 1024;
fl_SHADOW_EARRING = 2048;
fl_SHADOW_PENDANT = 4096;
}
...
itm_WEIGHT = 6;
itm_REQ_BLVL = 7;
itm_ENCH_SLOT_1 = 8;//1st Card slot
itm_ENCH_SLOT_2 = 9;
itm_ENCH_SLOT_3 = 10;
itm_ENCH_SLOT_4 = 11;
itm_BONUS_START = 12;
...
// var PATCH = 0; // 0 = Actual patch / 1 = 185/65 Patch / 2 = 2022 skill balance
}