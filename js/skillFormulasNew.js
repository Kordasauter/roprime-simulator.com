...
ALL_BASIC_ATTACK = {
	...
	skillFormula(SkillLV){return 100} //skillDamage => w_SkillMod in old skillFomulas.js
},
ALL_FIRST_AID = {
	id : 1,
	type : Support,
...
SW_MAGNUM_BREAK = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 100 + (20 * SkillLV)} 
},
SW_PROVOKE = {
	id : 8,
	type : Active,
...
SW_ENDURE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 100} 
},
...
SW_BERSERK = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 32 * SkillLV}
},
...
TH_IMPROVE_DODGE = {
	...
	if(n_A_JobSearch2() == cls_ASS || n_A_JobSearch2() == cls_ROG)
		...
		return 3 * SkillSearch(skill_TH_IMPROVE_DODGE);
	}
},
TH_STEAL = {
	id : 15,
...
TH_ENVENOM = {
	...
	skillFormula(SkillLV){return 15 * SkillLV} //basic attack + (15 * skill level)
},
TH_DETOXIFY = {
	id : 18,
	type : Support,
...
TH_SAND_ATTACK = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 125} 
},
TH_BACK_SLIDE = {
	id : 20,
	type : Active,
...
TH_STONE_FLING = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : true,
	skillFormula(SkillLV){return 50} 
},
...
AC_RUWACH = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 145} 
},
AC_TELEPORT = {
	id : 35,
	type : 0,/*TODO*/
...
AR_DOUBLE_STRAFE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 90 + (10 * SkillLV)} 
},
AR_ARROW_SHOWER = {
	id : 41,
	type : Offensive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 150 + (10 * SkillLV)} 
},
...
AR_ARROW_REPEL = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 150} 
},
// Mage
...
MA_NAPALM_BEAT = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 70 + (10 * SkillLV)} 
},
MA_SOUL_STRIKE = {
	id : 47,
	type : Offensive,
...
MA_FIRE_BALL = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 140 + (20 * SkillLV)} 
},
MA_FIRE_WALL = {
	id : 53,
	type : Offensive,
...
MA_FROST_DIVER = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 100 + (10 * SkillLV)} 
},
MA_LIGHTNING_BOLT = {
	id : 56,
	type : Offensive,
...
MA_THUNDER_STORM = {
	...
	isSpecialFormula : false,
	skillFormula(SkillLV){return 100 * SkillLV} 
},
MA_ENERGY_COAT = {
	id : 58,
	type : 0,/*TODO*/
...
ME_MAMMONITE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 100 + (50 * SkillLV)} 
},
ME_CART_REVOLUTION = {
	id : 66,
	type : Offensive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 150 + (100 * eval(document.calcForm.SkillSubNum.value) / 8000)}
},
ME_CHANGE_CART = {
	id : 67,
	type : 0,/*TODO*/
...
ME_CRAZY_UPROAR = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 30 * SkillLV}
},
...
KN_SPEAR_MASTERY = {
	...
	skillFormula(SkillLV){ 
		...
		if(n_A_WeaponType == weapTyp_SPEAR || n_A_WeaponType == weapTyp_SPEARII)
			if(SkillSearch(skill_KN_PECO_PECO_RIDE) || SkillSearch(skill_RUN_DRAGON_TRAINING))
			spear_mastery += 4 * SkillLV;
			else
			spear_mastery += 3 * SkillLV;

		//source : rathena > battle.cpp-> battle_addmastery function
		if(SkillSearch(skill_RUN_DRAGON_TRAINING))
			spear_mastery += SkillLV * 10;
...
KN_BRANDISH_SPEAR = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 400 + (100 * SkillLV)} 
},
KN_TWOHAND_QUICKEN = {
	id : 74,
	type : 0,/*TODO*/
...
KN_BOWLING_BASH = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 100 + (40 * SkillLV)} 
},
KN_PECO_PECO_RIDE = {
	id : 77,
	type : 0,/*TODO*/
...
AS_RIGHTHAND_MASTERY = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 50 + (SkillSearch(skill_AS_RIGHTHAND_MASTERY) * 10)} 
},
AS_LEFTHAND_MASTERY = {
	id : 80,
	type : Passive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 30 + (SkillSearch(skill_AS_LEFTHAND_MASTERY) * 10)} 
},
AS_KATAR_MASTERY = {
	id : 81,
	type : Passive,
...
AS_VENOM_SPLASHER = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 400 + (SkillLV * 100)} 
},
...
PR_MACE_MASTERY = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 3 * SkillSearch(skill_PR_MACE_MASTERY)} 
},
PR_IMPOSITIO_MANUS = {
	id : 90,
	type : Support,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 5 * SkillLV}
},
PR_SUFFRAGIUM = {
	id : 91,
	type : 0,/*TODO*/
...
PR_MAGNUS_EXORCISMUS = {
	...
	isSpecialFormula : false,
	skillFormula(SkillLV){
		if(n_B[en_RACE] == race_DEMON || n_B[en_RACE] == race_UNDEAD || n_B[en_ELEMENT] == ele_DARK || n_B[en_ELEMENT] == ele_UNDEAD)
			return 130;
		else
			return 100;
	} 
...
HU_LAND_MINE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : true,
	skillFormula(SkillLV){return [
		Math.floor((((n_A_DEX * (3 + (n_A_BaseLV / 100)) * (1 + (n_A_INT / 35))) * SkillLV)*0.9) + (40 * SkillSearch(skill_RAN_RESEARCH_TRAP))),
		Math.floor(((n_A_DEX * (3 + (n_A_BaseLV / 100)) * (1 + (n_A_INT / 35))) * SkillLV) + (40 * SkillSearch(skill_RAN_RESEARCH_TRAP))),
		Math.floor((((n_A_DEX * (3 + (n_A_BaseLV / 100)) * (1 + (n_A_INT / 35))) * SkillLV)*1.1) + (40 * SkillSearch(skill_RAN_RESEARCH_TRAP)))
	]}
},
HU_ANKLE_SNARE = {
	id : 107,
...
HU_CLAYMORE_TRAP = {
	...
	isSpecialFormula : true,
	skillFormula(SkillLV){return [
		Math.floor((((n_A_DEX * (3 + (n_A_BaseLV / 85)) * (1.1 + (n_A_INT / 35))) * SkillLV)*0.9) + (40 * SkillSearch(skill_RAN_RESEARCH_TRAP))),
		Math.floor(((n_A_DEX * (3 + (n_A_BaseLV / 85)) * (1.1 + (n_A_INT / 35))) * SkillLV) + (40 * SkillSearch(skill_RAN_RESEARCH_TRAP))),
		Math.floor((((n_A_DEX * (3 + (n_A_BaseLV / 85)) * (1.1 + (n_A_INT / 35))) * SkillLV)*1.1) + (40 * SkillSearch(skill_RAN_RESEARCH_TRAP)))
	]}
},
HU_REMOVE_TRAP = {
	id : 114,
...
HU_BEAST_BANE = {
	...
	skillFormula(SkillLV){
		if(n_B[en_RACE] == race_BRUTE || n_B[en_RACE] == race_INSECT)
			 return (4 * SkillLV) + HU_HUNTER_SPIRIT.skillFormula(SkillSearch(skill_HU_HUNTER_SPIRIT));
		else
			return 0;
	} 
},
...
HU_BLITZ_BEAT = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : true,
	skillFormula(SkillLV){return (SkillLV * 20) + (SkillSearch(skill_HU_STEEL_CROW) * 6) + (Math.floor(n_A_AGI / 2) * 2) + (Math.floor(n_A_DEX / 10) * 2)} 
},
HU_STEEL_CROW = {
	id : 119,
	type : 0,/*TODO*/
...
WI_FIRE_PILLAR = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : true,
	skillFormula(SkillLV){return (n_A_MATK[1] / 5) + 50} 
},
WI_SENSE = {
	id : 123,
	type : 0,/*TODO*/
...
WI_WATER_BALL = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 100 + (SkillLV * 30)} 
},
WI_ICE_WALL = {
	id : 129,
	type : 0,/*TODO*/
...
WI_FROST_NOVA = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 66 + (7 * SkillLV) - Math.floor((SkillLV-1) / 3)} 
},
WI_STORM_GUST = {
	id : 131,
	type : Offensive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 70 + (SkillLV * 50)} 
},
WI_EARTH_SPIKE = {
	id : 132,
	type : Offensive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 200} 
},
WI_HEAVENS_DRIVE = {
	id : 133,
	type : Offensive,
...
BS_HILT_BINDING = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 4 * SkillLV}
},
BS_ORE_DISCOVERY = {
	id : 147,
	type : 0,/*TODO*/
...
BS_WEAPONRY_RESEARCH = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return SkillLV * 2} 
},
BS_WEAPON_REPAIR = {
	id : 149,
	type : 0,/*TODO*/
...
CR_FAITH = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 200 * SkillLV} 
},
CR_GUARD = {
	id : 157,
	type : 0,/*TODO*/
...
CR_SHIELD_BOOMERANG = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 80 * SkillLV} 
},
CR_SHIELD_REFLECT = {
	id : 160,
	type : 0,/*TODO*/
...
CR_HOLY_CROSS = {
	...
	isSpecialFormula : false,
	skillFormula(SkillLV){
	if (n_A_WeaponType == weapTyp_2HSPEAR)
		return 2 * (100 + (35 * SkillLV))
	else
...
CR_DEFENDING_AURA = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 5 + (15 * SkillLV)} 
},
CR_SPEAR_QUICKEN = {
	id : 166,
	type : 0,/*TODO*/
...
RG_BACK_STAB = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 300 + (40 * SkillLV)} 
},
RG_STALK = {
	id : 170,
	type : 0,/*TODO*/
...
RG_SIGHTLESS_MIND = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 50 + (150 * SkillLV)} 
},
RG_DIVEST_WEAPON = {
	id : 172,
	type : 0,/*TODO*/
...
MO_RAGING_TRIFECTA_BLOW = {
	...
	hitDivisibility : "3",
	isSpecialFormula : false,
	skillFormula(SkillLV){return 300} 
},
...
MO_RAGING_THRUST = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return (450 + (150 * SkillLV)) + (n_A_STR * 5)} 
},
MO_SNAP = {
	id : 190,
	type : 0,/*TODO*/
...
MO_FLEE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 1 + (SkillLV - 1) + Math.floor(SkillLV / 2)} 
},
MO_THROW_SPIRIT_SPHERES = {
	...
	hitDivisibility : "5",
	isSpecialFormula : false,
	skillFormula(SkillLV){return 600 + (200 * SkillLV)} 
	/*TODO*/
...
BA_MELODY_STRIKE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 110 + (40 * SkillLV)} 
},
...
AL_AXE_MASTERY = {
	...
	isSpecialFormula : false,
	skillFormula(SkillLV){ 
		if(n_A_WeaponType == weapTyp_AXE || n_A_WeaponType == weapTyp_2HAXE || n_A_WeaponType == weapTyp_SWORD) 
			return 3 * SkillLV;
		else 
			return 0;
		}
...
AL_ACID_TERROR = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return (200 * SkillLV) + (100 * SkillSearch(skill_AL_POTION_RESEARCH))} 
},
AL_POTION_PITCHER = {
	id : 245,
	type : 0,/*TODO*/
...
AL_BOMB = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return (60 * SkillLV) + (10 * SkillSearch(skill_AL_POTION_RESEARCH))}
},
...
LK_CLASHING_SPIRAL = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : true,
	skillFormula(SkillLV){return (150 + (50 * SkillLV)) * (n_A_BaseLV / 100)}
},
LK_TRAUMATIC_BLOW = {
	id : 260,
	type : Offensive,
...
LK_VITAL_STRIKE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 50 + (10 * SkillLV)}
},
...
AX_ADVANCED_KATAR_MASTERY = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 10 + (2 * SkillLV) }
},
AX_SOUL_DESTROYER = {
	id : 263,
	type : Offensive,
	...
	skillFormula(SkillLV){
		if(PATCH < 2)
			return 350 + (50 * SkillLV)
		else
		 return ((SkillLV * 150) + n_A_STR + n_A_INT) * (n_A_BaseLV / 100)
	}
},
AX_METEOR_ASSAULT = {
	id : 264,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return ((100 + (120 * SkillLV)) + (n_A_STR * 5)) * (n_A_BaseLV / 100)}
},
...
AX_ENCHANT_DEADLY_POISON = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 250 + (30 * SkillLV)}
},
...
SN_FALCON_EYES = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 2 * SkillLV}
},
SN_FALCON_ASSAULT = {
	id : 271,
	type : Offensive,
	...
	skillFormula(SkillLV){
		...
		formula *=SkillLV;
		formula += (SkillSearch(skill_HU_STEEL_CROW) * 6);
		formula *= (SkillSearch(skill_HU_STEEL_CROW) / 20) + SkillLV + (n_A_BaseLV / 50);
		return formula;
	}
},
SN_FOCUSED_ARROW_STRIKE = {
	...
	skillFormula(SkillLV){
		if(PATCH < 2)
			return (150 + (200 * SkillLV)) * (n_A_BaseLV/100);
		else
			return (300 + (300 * SkillLV)) * (n_A_BaseLV/100);
	}
},
SN_WIND_WALK = {
	id : 273,
...
HW_MYSTICAL_AMPLIFICATION = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return SkillLV * 5}
},
HW_NAPALM_VULCAN = {
	id : 277,
	type : Offensive,
	...
	hitDivisibility : "n_A_ActiveSkillLV",
	isSpecialFormula : false,
	skillFormula(SkillLV){return 70 * SkillLV}
},
...
PA_GLORIA_DOMINI = {
	...
	hitDivisibility : "3",
	isSpecialFormula : false,
	skillFormula(SkillLV){return (500 + (150 * SkillLV)) * (n_A_BaseLV / 100)}
},
PA_MARTYR_RECONING = {
	id : 284,
	type : Offensive,
...
CH_RAGING_PALM_STRIKE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return ((200 + (100 * SkillLV)) + (n_A_STR * 5)) * (n_A_BaseLV / 100)}
},
CH_GLACIER_FIST = {
	id : 289,
	type : Offensive,
...
CH_CHAIN_CRUSH_COMBO = {
	...
	isSpecialFormula : false,
	skillFormula(SkillLV){return (200 * SkillLV) * (n_A_BaseLV / 100)}
},
CH_ZEN = {
	id : 291,
	type : Active,/*TODO*/
...
CG_ARROW_VULCAN = {
	...
	hitDivisibility : "9",
	isSpecialFormula : false,
	skillFormula(SkillLV){return (500 + (100 * SkillLV)) * (n_A_BaseLV / 100)}
},
CG_SHELTERING_BLISS = {
	id : 293,
	type : Support,/*TODO*/
...
AS_VENOM_KNIFE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 500}
},
HU_FANTASTIC_ARROW = {
	id : 307,
	type : Offensive,
...
KN_CHARGE_ATTACK = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 700}
},
ALL_NO_DEATH_BONUS = {
	id : 309,
	type : 0,/*TODO*/
...
HEAVENS_DRIVE2 = {/* need to be removed ? */
	id : 319,
	type : 0,/*TODO*/
	range : [1],
	forcedElement : false,
...
WATER_BALL2 = {/* need to be removed ? */
	id : 320,
	type : 0,/*TODO*/
	range : [1],
	forcedElement : false,
...
AX_DEADLY_POISON_CONSUMED = {/* need to be removed ? */
	id : 323,
	type : 0,/*TODO*/
	range : [1],
	forcedElement : false,
...
PA_RAPID_SMITING = {
	...
	isSpecialFormula : false,
	skillFormula(SkillLV){
		if(n_A_Equip[eq_SHIELD] != 305)//no shield
			return ((300 + (200 * SkillLV)) + (n_A_LEFT_DEF_PLUS * 4) + ItemOBJ[n_A_Equip[eq_SHIELD]][itm_WEIGHT]) * (n_A_BaseLV / 100);
		return 0;
		}
},
HW_GRAVITY_FIELD = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return (100 * SkillLV) * (n_A_BaseLV / 100);}
},
MS_HIGH_SPEED_CART_RAM = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return Math.floor(eval(document.calcForm.SkillSubNum.value) / (16 - SkillLV));}
},
MS_MAXIMUM_POWER_THUST = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 20 * SkillLV}
},
	...
	skillFormula(SkillLV){
		...
		if(PATCH <= 2){
			for(let i = 0;i <= 2;i++){
				...
				damage[i] -= n_B[en_SOFTDEF] + n_B[en_SOFTMDEF] + n_B[en_HARDDEF] + n_B[en_HARDMDEF];
				damage[i] /= 20;
...
TK_TORNADO_KICK = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 160 + (20 * SkillLV)}
},
TK_HEEL_DROP_STANCE = {
	id : 332,
	type : Active,/*TODO*/
...
TK_ROUNDOUSE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 190 + (30 * SkillLV)}
},
...
TK_FLYING_KICK = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 30 + (10 * SkillLV)}
},
TK_PEACEFUL_BREAK = {
	id : 340,
	type :Passive,/*TODO*/
...
TK_HAPPY_BREAK = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 3 * SkillLV}
},
TK_KIHOP = {
	id : 342,
	type : Passive,/*TODO*/
...
SL_ESTIN = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 10 * SkillLV}
},
SL_ESTUN = {
	id : 374,
	type : Offensive,
...
SL_ESMA = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return n_A_BaseLV + 40}
},
SL_ESWOO = {
	id : 376,
	type : Active,/*TODO*/
...
AS_SONIC_ACCELERATION = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return Math.floor(getWeaponATK(0)/10);}
},
...
CR_SHIELD_BOOMERANG_SL = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 160 * SkillLV} 
},
...
HU_HUNTER_SPIRIT = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return n_A_STR * SkillLV}
},
HU_BEAST_STRAFING = {
	id : 391,
	type : Offensive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 50 + (n_A_STR * 8)}
},
...
NIN_THROW_DAGGER = {
	...
	hitDivisibility : "3",
	isSpecialFormula : false,
	skillFormula(SkillLV){return 100 + (5 * SkillLV)}
},
NIN_THROW_KUNAI = {
	id : 395,
	type : Offensive,
...
NIN_THROW_HUUMA_SHURIKEN = {
	...
	hitDivisibility : "3",
	isSpecialFormula : false,
	skillFormula(SkillLV){return (250 * SkillLV) - 50}
},
NIN_THROW_COINS = {
	id : 397,
	type : Offensive,/*TODO*/
...
NIN_KILLING_STRIKE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : true,
	skillFormula(SkillLV){return SkillLV;}
},
NIN_NINJA_MASTERY = {
	id : 406,
	type : Passive,
...
NIN_FLAMING_PETALS = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 90}
},
NIN_BLAZE_SHIELD = {
	id : 408,
	type : Offensive,
...
NIN_EXPLODING_DRAGON = {
	...
	hitDivisibility : "3",
	isSpecialFormula : false,
	skillFormula(SkillLV){return 150 + (150 * SkillLV)}
},
NIN_FREEZING_SPEAR = {
	id : 410,
	type : Offensive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 70 +(2 * SkillSearch(skill_NIN_WATERY_EVASION))}
},
NIN_WATERY_EVASION = {
	id : 411,
	type : Support,
...
NIN_LIGHTNING_JOLT = {
	...
	hitDivisibility : "3",
	isSpecialFormula : false,
	skillFormula(SkillLV){return 100 + (100 * SkillLV)}
},
NIN_FIRST_WIND = {
	id : 415,
	type : Offensive,
...
GS_COING_FLING = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : true,
	skillFormula(SkillLV){return n_A_JobLV}
},
GS_TRIPLE_ACTION = {
	id : 418,
	type : Offensive,
	...
	hitDivisibility : "3",
	isSpecialFormula : false,
	skillFormula(SkillLV){return 450}
},
GS_BULLS_EYE = {
	id : 419,
	type : Offensive,
...
GS_TRIGGER_HAPPY_SHOT = {
	...
	hitDivisibility : "5",
	isSpecialFormula : false,
	skillFormula(SkillLV){return 500 + (50 * SkillLV)}
},
GS_DESPERADO = {
	id : 429,
	type : Offensive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 50 + (50 * SkillLV);}
},
GS_TRACKING = {
	id : 430,
	type : Offensive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 200 + (100 * SkillLV)}
},
GS_DISARM = {
	id : 431,
	type : Active,/*TODO*/
...
GS_WOUNDING_SHOT = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 200 + (20 * SkillLV)}
},
GS_GATLING_FEVER = {
	id : 433,
	type : Active,/*TODO*/
...
GS_FULL_BLAST = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 300 + (100 * SkillLV)}
},
GS_SPREAD_SHOT = {
	id : 436,
	type : Offensive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 200 + (30 * SkillLV)}
...
RUN_ENCHANT_BLADE = {
	...
	skillFormula(SkillLV){
		...
		return ((100 + (20 * SkillLV)) * (n_A_BaseLV / 150) + n_A_INT) - n_B[en_HARDMDEF] - n_B[en_SOFTMDEF]; //matk added in getFinalDamage function
	}
},
RUN_SONIC_WAVE = {
	id : 446,
	...
	skillFormula(SkillLV){
		if(PATCH == 0)
			...
			return (1050 + (150 * SkillLV)) * n_A_BaseLV/100;
	}
},
RUN_DEATH_BOUND = {
	id : 447,
	...
	skillFormula(SkillLV){
		...
		myInnerHtml( "CRIATK", '<font color="#0000FF"><b>' + (0.7 * damage) + '</b></font>', 0 );
		
		// Calculate incoming damage
		myInnerHtml( "CRInumname", '<font color="#FF0000"><b>Incoming Damage</b></font>', 0 );
		myInnerHtml( "CRInum", '<font color="#FF0000"><b>' + (0.3 * damage) + '</b></font>', 0 );
		return 0;
	}
},
RUN_HUNDRED_SPEAR = {
	...
	skillFormula(SkillLV){
		if(PATCH < 2)
			return ((600 + (80 * SkillLV) + ItemOBJ[n_A_Equip[eq_WEAPON]][itm_WEIGHT]) * (n_A_BaseLV / 100)) + (SkillSearch(skill_LK_CLASHING_SPIRAL) * 50);
		return ((400 + (200 * SkillLV)) * (n_A_BaseLV / 100)) + (SkillSearch(skill_LK_CLASHING_SPIRAL) * 50);
	}
},
RUN_WIND_CUTTER = {
	id : 449,
	...
	accuracyCheck : true,
	bypassDef : false,
	hitAmount : "if(PATCH == 2 && n_A_WeaponType ==weapTyp_SWORDII){ 2 }else{ 1 }",
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){
		if(PATCH < 2)
			return 100 + (50 * SkillLV) * (n_A_BaseLV / 100)
...
RUN_IGNITION_BREAK = {
	...
	skillFormula(SkillLV){
		if(PATCH < 2){
			let distanceMod = 350 - (50 * parseInt(formElements["SkillSubNum"].value));
...
RUN_PHANTOM_THRUST = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return ((50 * SkillLV) + (SkillSearch(skill_KN_SPEAR_MASTERY) * 10)) * (n_A_BaseLV / 150)}
},
RUN_DRAGON_TRAINING = {
	id : 452,
	type : Passive,
	...
	skillFormula(SkillLV){
		...
		switch(PATCH)
		{
			case 0:
				...
				return ((currentHP / 50) + (n_A_MaxSP / 4)) * (SkillLV * n_A_BaseLV / 150) * (0.95 + ((SkillSearch(skill_RUN_DRAGON_TRAINING) * 5) / 100));
			case 1:
				// [(CurrHP ÷ 50) + (MaxSP ÷ 4)] × (SkillLv × BaseLv ÷ 150) × (95 + DragonTraining_Lv × 5)% × (100 + Ranged Damage Modifiers)% x (Elemental Modifiers)%
				return ((currentHP / 50) + (n_A_MaxSP / 4)) * (SkillLV * n_A_BaseLV / 150) * (0.95 + ((SkillSearch(skill_RUN_DRAGON_TRAINING) * 5) / 100)) * (1 + (getRangedMultiplier() / 100) /** (1 - (enemy Demi humain reduction/100))*/ * getSkillMultiplier(skill_RUN_DRAGON_BREATH) * (getPropertyMultiplier() / 100));
			case 2:
				//[(CurrHP ÷ 50) + (MaxSP ÷ 4)] × (SkillLv × BaseLv ÷ 100) × (90 + DragonTraining_Lv × 10)% × (100 + Ranged Damage Modifiers)% x (Elemental Modifiers)%
				return ((currentHP / 50) + (n_A_MaxSP / 4)) * (SkillLV * n_A_BaseLV / 100) * (0.9 + ((SkillSearch(skill_RUN_DRAGON_TRAINING) * 10) / 100)) * (1 + (getRangedMultiplier() / 100) /** (1 - (enemy Demi humain reduction/100))*/ * getSkillMultiplier(skill_RUN_DRAGON_BREATH) * (getPropertyMultiplier() / 100));
		}
		return 0;
	}
},
RUN_DRAGON_HOWLING = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 50 + (6*SkillLV)}
},
RUN_RUNE_MASTERY = {
	id : 455,
	type : Passive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 30 + (2 * SkillLV) + ((n_A_DEX / 30) + (n_A_LUK / 10) + (n_A_JobLV / 10))}
},
RUN_GIANT_GROWTH = {
	id : 456,
	type : Active,
	...
	skillFormula(SkillLV){
		switch(PATCH)
		{
			...
			case 2:
				...
				return ((SkillSearch(skill_RUN_RUNE_MASTERY) + (n_A_STR / 5.7)) * 100) * (n_A_BaseLV / 100);
		}
		return 0
	}
},
RUN_STONEHARD_SKIN = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return (n_A_JobLV * SkillSearch(skill_RUN_RUNE_MASTERY)) / 4}
},
RUN_FIGHTING_SPIRIT = {
	id : 460,
	type : Passive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){// Asir Rune
	if( SkillLV )
		return 70 + (SkillLV * 7);
	else
		return 0
...
RUN_CRUSH_STRIKE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return n_A_WeaponLV * ( n_A_Weapon_ATKplus + 6 ) + ItemOBJ[n_A_Equip[eq_WEAPON]][itm_ATK] / 100.0 + ItemOBJ[n_A_Equip[eq_WEAPON]][itm_WEIGHT] / 100.0;}
},
RUN_REFRESH = {
	id : 463,
	type : 0,/*TODO*/
...
GLT_RESEARCH_NEW_POISON = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return (30 + (5 * SkillLV)) + ((n_A_DEX + n_A_JobLV + (n_A_LUK / 2)) / 20)}
},
	...
	skillFormula(SkillLV){
		switch(PATCH)
		{
			case 0:
				...
				return ((300 + (100 * SkillLV)) * (n_A_BaseLV / 120)) + (n_A_AGI / 2) + (n_A_JobLV / 4);
			case 1:
			case 2:
				//[(300 + (Skill Level x 150)) x BaseLv ÷ 120) + (AGI × 2) + (JobLv × 4)]%
				return ((300 + (150 * SkillLV)) * (n_A_BaseLV / 120)) + (n_A_AGI / 2) + (n_A_JobLV / 4);
		}
		return 0
	}
},
...
GLT_VENOM_PRESSURE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 1000}
},
GLT_POISON_SMOKE = {
	id : 476,
	type : Active,/*TODO*/
	...
	skillFormula(SkillLV){
		switch(PATCH)
		{
			...
			case 1:
				...
				return ((400 + (80 * SkillLV)) * (n_A_BaseLV / 100)) + (n_A_AGI * parseInt(formElements["SkillSubNum"].value));
			case 2:
				//[((80 × Skill Level) × BaseLv ÷ 100) + (SpinCount × 200) + (AGI × 3)]%
				return (((80 * SkillLV)) * (n_A_BaseLV / 100)) + (parseInt(formElements["SkillSubNum"].value) * 200) + (n_A_AGI / 3);
		}
		return 0}
},
GLT_POISON_PARALYZE = {
	...
	skillFormula(SkillLV,isMagicalPart){
		switch(PATCH)
		{
			...
			case 2:
				...
				if(isMagicalPart)
					return (400 + (40 * SkillLV));
				else
					return (150 + (15 * SkillLV));
		}
		return 0}
},
ABI_SILENTIUM = {
...
RAN_RANGER_MAIN = {
	...
	isSpecialFormula : false,
	skillFormula(SkillLV){
		if(n_B[en_RACE] == race_BRUTE || n_B[en_RACE] == race_FISH || n_B[en_RACE] == race_PLANT)
			return 5 * SkillLV;
		else
			return 0;
	}
...
RAN_AIMED_BOLT = {
	...
	skillFormula(SkillLV){
		switch(PATCH)
		{
			...
			case 2:
				if(SkillSearch(skill_RAN_FEAR_BREEZE))// w/fear breeze:[(800 + (Skill Level x 35)) x (BaseLv ÷ 100)]%
...
RAN_ARROW_STORM = {
	...
	skillFormula(SkillLV){
		switch(PATCH)
		{
			...
			case 2:
				if(SkillSearch(skill_RAN_FEAR_BREEZE))// w/ fear breeze:(200 + 180 × Skill_Level)%
...
RAN_WARG_DASH = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 300 /*+ (parseInt(formElements["SkillSubNum"].value) * 10 / 8)*/ } //TODO : weight mod
},
RAN_WARG_BITE = {
	id : 527,
	type : Offensive,
...
WAR_RADIUS = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return(5 * SkillLV) + (n_A_INT / 15) + (n_A_BaseLV / 15)} //FCT reduction 
},
WAR_DRAIN_LIFE = {
	id : 534,
	type : Offensive,
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return ((200 * SkillLV) + n_A_INT) * (n_A_BaseLV / 100);
	}
},
WAR_SOUL_EXPANSION = {
	id : 535,
...
WAR_CRIMSON_ROCK = {
	...
	skillFormula(SkillLV){
		if(PATCH < 2)
			return ((300 * SkillLV) * (n_A_BaseLV / 100)) + 1300;
...
WAR_HELL_INFERNO = {
	...
	skillFormula(SkillLV){
		if(PATCH < 2)
			return [(60 * SkillLV) * (n_A_BaseLV / 100),(240 * SkillLV) * (n_A_BaseLV / 100)];
		return [(400 * SkillLV) * (n_A_BaseLV / 100),(600 * SkillLV) * (n_A_BaseLV / 100)];
	}
},
WAR_COMET = {
	id : 542,
...
WAR_FROSTY_MISTY = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return (200 + (100 * SkillLV)) * (n_A_BaseLV / 100);}
},
WAR_JACK_FROST = {
	id : 544,
	type : Offensive,
...
WAR_CHAIN_LIGHTNING = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 500 + (100 * SkillLV)}
},
WAR_SIENNA_EXECRATE = {
	id : 546,
	type : Active,/*TODO*/
...
MEC_AXE_BOOMERANG = {
	...
	isSpecialFormula : false,
	skillFormula(SkillLV){
		return ((250 * (SkillLV * 50)) + ItemOBJ[n_A_Equip[eq_WEAPON]][itm_WEIGHT]) * (n_A_BaseLV / 100);
	}
},
MEC_POWER_SWING = {
	id : 557,
...
MEC_FAW_SILVER_SNIPER = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : true,
	skillFormula(SkillLV){return 100 + (SkillLV * 200);}
},
MEC_FAW_MAGIC_DECOY = {
	id : 560,
	type : Active,
...
MEC_MAGIC_GEAR_LICENSE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 15 * SkillLV}
},
MEC_REPAIR = {
	id : 563,
	type : Support,/*TODO*/
...
MEC_ARM_CANNON = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			case 0:
			case 1:
				return (300 + ((300 + (50 * (2 - n_B[en_SIZE]))) * SkillLV)) * (n_A_BaseLV / 120);
			case 2:
...
MEC_MAINFRAME_RESTRUCTURE = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){return 20 + (20 * SkillLV);}
},
MEC_SELF_DESTRUCTION = {
	...
	skillFormula(SkillLV){
		...
		return (((SkillLV +1) * (SkillSearch(skill_MEC_MAINFRAME_RESTRUCTURE) + 8) * (currentSP + n_A_VIT)) * (n_A_BaseLV / 100)) + currentHP;
	}
},
MEC_EMERGENCY_COOL = {
	id : 576,
...
ROY_SHIELD_SPELL = {
	...
	skillFormula(SkillLV){
		...
		{
			if(SkillLV)
				return ItemOBJ[n_A_Equip[eq_SHIELD]][itm_DEF];
		}
		else
		{
			if(SkillLV)
...
ROY_EXCEED_BREAK = {
	...
	skillFormula(SkillLV){
		...
		switch(PATCH){
			...
			case 1:
			case 2:
				return ((100 * SkillLV) + (n_A_JobLV * 10) + (weaponWeight * weaponLevel)) * (n_A_BaseLV / 100);
		}
		return 0;
	}
},
	...
	skillFormula(SkillLV){
		...
		switch(PATCH){
			...
			case 1:
				switch(numHits){
					case 0:
						return ( ( SkillLV * 200 ) + ( SkillSearch( skill_CR_SPEAR_QUICKEN ) * 50 ) ) * (n_A_BaseLV / 100);
					case 1:
						sk_dmg = ( ( SkillLV * 200 ) + ( SkillSearch( skill_CR_SPEAR_QUICKEN ) * 50 ) ) * (n_A_BaseLV / 100);
						return sk_dmg + (( (SkillLV * 100) + ( n_A_STR + n_A_DEX ) ) * (n_A_BaseLV / 100));
					case 2:
						sk_dmg = ( ( SkillLV * 200 ) + ( SkillSearch( skill_CR_SPEAR_QUICKEN ) * 50 ) ) * (n_A_BaseLV / 100);
						sk_dmg += (( (SkillLV * 100) + ( n_A_STR + n_A_DEX ) ) * (n_A_BaseLV / 100));
...
ROY_MOON_SLASHER = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			...
			case 1:
			case 2:
				return ((SkillLV * 120) + (SkillSearch( skill_ROY_OVERBRAND ) * 80)) * (n_A_BaseLV / 100);
		}
		return 0;
	}
},
...
ROY_INSPIRATION = {
	...
	skillFormula(SkillLV){
		if(SkillLV)
			if(PATCH < 2)
				return ( 40 * SkillLV ) + ( 3 * n_A_JobLV );// Inspiration [Skill Level x 40 ] + [Caster’s Job Level x 3 ]
			else if(PATCH == 2)
				return( 40 * SkillLV );// Inspiration [Skill Level x 40 ]
		return 0;
	}
},
...
SHA_FEINT_BOMB = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			...
			case 1:
			case 2:
				return (SkillLV + 1) * (n_A_DEX / 2) * (n_A_JobLV / 10) * (n_A_BaseLV / 120);
			default:
				return 0;
        }
    }
...
SUR_EARTH_SHAKER = {
	...
	skillFormula(SkillLV){
		...
		switch(PATCH){
			...
			case 2:
				if(visible)
					return ((300 * SkillLV) * (n_A_BaseLV / 100)) + (n_A_STR * 2);
		...
		switch(PATCH){
			...
			case 1:
				if ( SkillSearch( skill_MO_FURY ) )
					return ( ( SkillSearch( skill_MO_FURY ) * 20 ) + ( SkillLV * 20 ) ) * numSpheres * (n_A_BaseLV / 120.0);
				else
					return (( SkillLV * 20 ) * numSpheres) * (n_A_BaseLV / 150.0);
			case 2:
				return  ((SkillLV * 350) + (200 * SkillSearch(skill_MO_FURY))) * (n_A_BaseLV / 100.0);
...
SUR_KNUCKLE_ARROW = {
	...
	skillFormula2(SkillLV){// Knockback damage only
		let addedDamage = 0;
		switch(PATCH){
			case 0:
					addedDamage = (SkillLV * 150) + ((n_B[en_LEVEL] * 5) * (n_A_BaseLV / 150));
		...
		switch(PATCH){
			...
			case 2:
				if(afterFallenEmpire)
					...
					return ((HPCost + SPCost) / 4) * (n_A_BaseLV / 100);
			default:
				return 0;
        }
    }
...
SUR_GATE_OF_HELL = {
	...
	skillFormula(SkillLV){
		...
		switch(PATCH){
			...
			case 2:
				if(afterFallenEmpire)
					return (800 * SkillLV) * (n_A_BaseLV / 100);
...
SUR_GENTLE_TOUCH_CHANGE = {
	...
	skillFormula(SkillLV){
		switch(PATCH)
		{
			case 0:
			case 1:
				if( SkillLV)// Gentle Touch Convert: ATK [{(Caster’s DEX / 4) + (Caster’s STR / 2)} x Skill Level / 5]
					...
					return ( ( (acolyteBuffs[ksSuraDexterity] / 4.0) + (acolyteBuffs[ksSuraStrength] / 2.0) ) * acolyteBuffs[ksPPChange] / 5.0 );
				else
					return 0;
	...
	skillFormula(SkillLV){
		switch(PATCH){
			...
			case 1:
				...
				if(SkillLV <= 5)
					return (100 + (100 * SkillLV)) * (n_A_BaseLV / 100);
...
MIWA_METALLIC_SOUND = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			...
			case 1:
			case 2:
				return ((120 * SkillLV) + (SkillSearch(skill_MIWA_VOICE_LESSONS) * 60)) * (n_A_BaseLV / 100);
			default:
				return 0;
        }
    }
...
MIWA_SEVERE_RAINSTORM = {
	...
	skillFormula(SkillLV){
		...
		switch(PATCH){
			...
			case 1:
				return ((n_A_DEX + n_A_AGI) * (SkillLV / 5)) * (n_A_BaseLV / 100) * weapTypeBonus;
			case 2:
				if(n_A_WeaponType == weapTyp_INSTRUMENT || n_A_WeaponType == weapTyp_WHIP)
					return ((120 * SkillLV) + ((n_A_DEX + n_A_AGI) / 2)) * (n_A_BaseLV / 100);
...
SOR_STRIKING = {
	...
	skillFormula(SkillLV){
		if(PATCH < 2)
			if(SkillLV)
				return ((8 + (otherBuffs[ksStriking] * 2)) * n_A_WeaponLV) + (5 * otherBuffs[ksStrikingEndowBonus]);
			else
				return 0;
		else
			return 20 * SkillLV;
...
SOR_EARTH_GRAVE = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			case 0:
			case 1:
				return ((SkillLV * n_A_INT) + (SkillSearch( skill_SA_ENDOW_EARTH ) * 200)) * (n_A_BaseLV / 100);
			case 2:
				return (((SkillLV + 2) * n_A_INT) + (SkillSearch( skill_SA_ENDOW_EARTH ) * 300)) * (n_A_BaseLV / 100);
			default:
				return 0;
        }
    }
...
SOR_DIAMOND_DUST = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			case 0:
			case 1:
				return ((SkillLV * n_A_INT) + (SkillSearch( skill_SA_ENDOW_WATER ) * 200)) * (n_A_BaseLV / 100);
			case 2:
				return (((SkillLV + 2) * n_A_INT) + (SkillSearch( skill_SA_ENDOW_WATER ) * 300)) * (n_A_BaseLV / 100);
			default:
				return 0;
        }
    }
...
SOR_VARETYR_SPEAR = {
	...
	skillFormula(SkillLV){
		...
		switch(PATCH){
			...
			case 1:
				return (((SkillLV * n_A_INT) / 2) + (endowLevel * 120) + (strikingLevel * 120)) * (n_A_BaseLV / 100);
			case 2:
				return ((((SkillLV + 2) * n_A_INT) / 2) + ((endowLevel + strikingLevel) * 150)) * (n_A_BaseLV / 100);
			default:
				return 0;
        }
    }
...
GEN_CART_TORNADO = {
	...
	skillFormula(SkillLV){
		...
		switch(PATCH){
			case 0:
				return (50 * SkillLV) + (SkillSearch(skill_GEN_CART_REMODELING) * 50) + (Curr_Cart_Weight / (150 - SU_STR));
			case 1:
				return (100 * SkillLV) + (SkillSearch(skill_GEN_CART_REMODELING) * 50) + (Curr_Cart_Weight / (150 - SU_STR));
			case 2:
				return (200 * SkillLV) + (SkillSearch(skill_GEN_CART_REMODELING) * 50) + (Curr_Cart_Weight / (150 - SU_STR));
			default:
				return 0;
        }
    }
...
GEN_CART_CANNON = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			case 0:
			case 1:
				return (60 * SkillLV) + ((SkillSearch(skill_GEN_CART_REMODELING) * 50) * (n_A_INT / 40));
			case 2:
				return ((250 * SkillLV) + ((SkillSearch(skill_GEN_CART_REMODELING) * (SkillLV * 20)) * (n_A_INT * 2 ))) * (n_A_BaseLV / 100);
			default:
				return 0;
        }
    }
...
GEN_HELLS_PLANT = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			case 0:
			case 1:
				return (((SkillLV * n_A_BaseLV) * 10) + (((n_A_INT * 7) / 2) * (18 + (n_A_JobLV / 4)))) * (5 / (10 - SkillSearch(AL_SUMMON_FLORA)));
			case 2:
				return ((100 * SkillLV) + (n_A_INT * SkillSearch(AL_SUMMON_FLORA))) * (n_A_BaseLV / 100);
			default:
				return 0;
        }
    }
...
ROY_SHIELD_SPELL_ATK = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			case 0:
			case 1:
				return ( n_A_BaseLV * 4 + ItemOBJ[n_A_Equip[eq_SHIELD]][itm_DEF] * 10 + n_A_VIT * 2 );
			case 2:
			default:
				return 0;
        }
...
ROY_SHIELD_SPELL_MATK = {
	...
	skillFormula(SkillLV){
		let shieldMdef = 0;
		for ( let i = itm_BONUS_START; ItemOBJ[n_A_Equip[eq_SHIELD]][i] !== bon_NONE; i += 2 )
		{ // find shield MDEF
...
ROY_OVERBRAND_OLD = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			...
			let sk_dmg = ( ( n_A_ActiveSkillLV * 8.0 / 3.0 ) + ( SkillSearch( skill_CR_SPEAR_QUICKEN ) / 3.0 ) ) * n_A_BaseLV / 100.0;
			
			if ( numHits >= 2 )
			{ // Deals Swing Damage to targets in 5x2 cell infront of the Caster.
				return sk_dmg + ( n_A_ActiveSkillLV * 2.0 + ( 0.02 * ( n_A_STR + n_A_DEX ) / 3.0 ) ) * n_A_BaseLV / 100.0;
			}
			if ( numHits >= 3 )
...
KAG_CROSS_STRIKE = {
	...
	skillFormula(SkillLV){
		...
		switch(PATCH){
			...
			case 1:
				if(cross)
					return ((150 * SkillLV) * (n_A_ActiveSkillLV / 120)) * (SkillLV * n_A_BaseLV);
				return (150 * SkillLV) * (n_A_ActiveSkillLV / 120);
			case 2:
				if(cross)
					return ((200 * SkillLV) * (n_A_ActiveSkillLV / 120)) * (SkillLV * n_A_BaseLV);
...
KAG_THROW_EXPLOSIVE_KUNAI = {
	...
	skillFormula(SkillLV){
		switch(PATCH){
			...
			case 1:
			case 2:
				return ((SkillLV * (50 + (n_A_DEX / 4))) * SkillSearch( skill_NIN_DAGGER_THROWING_PRACTICE ) * 0.4 * n_A_BaseLV / 120) + (n_A_JobLV * 10);
			default:
				return 0;
        }
    }
...
SUR_KNUCKLE_ARROW_KNOCKBACK = {
	...
	hitDivisibility : `1`,
	isSpecialFormula : false,
	skillFormula(SkillLV){// Knockback damage only
		switch(PATCH){
			case 0:
...
function displayDamage(finalDamage,sk)
{
	...
	if(sk.id == skill_SUR_KNUCKLE_ARROW)
	{
		if(formElements["SkillSubNum"].checked)
			tmpDmg = getFinalDamage(getBaseDamage(0),SUR_KNUCKLE_ARROW_KNOCKBACK,n_A_ActiveSkillLV,0);
	}
	for(let i = 0;i <= 2;i++){
		//damage can't go below 0
		if(finalDamage[i]<0)
		...
		{
			InnStr[i] = finalDamage[i] + " (" + (finalDamage[i]/eval(sk.hitDivisibility)) + " x " + eval(sk.hitDivisibility) + ")";
		}
		else if(eval(sk.hitAmount) != 1)
		{
			InnStr[i] = finalDamage[i] + " (" + (finalDamage[i]/eval(sk.hitAmount)) + " x " + eval(sk.hitAmount) + ")";
		}
		else
		{
			if(sk.id == skill_SUR_KNUCKLE_ARROW)
			{
				if(formElements["SkillSubNum"].checked)
					InnStr[i] = finalDamage[i] + "<BR>(" + (finalDamage[i] - tmpDmg[i]) + " + " +  tmpDmg[i] + " Knockback damage)";
				else
					InnStr[i] = finalDamage[i];
			}
			else
				InnStr[i] = finalDamage[i];
		}
...
function displayAdditionalDamage()
{
	if(Skill[n_A_ActiveSkill].canCrit)
	{
		...
		if(((SkillSearch(skill_TH_DOUBLE_ATTACK) && (n_A_WeaponType == weapTyp_DAGGER)) || 
		...
		//Giant Growth
		if(SkillSearch(skill_RUN_GIANT_GROWTH) && n_A_ActiveSkill == skill_ALL_BASIC_ATTACK)
		{
			str_Title += "<BR>Giant Growth (CRIT)";
			str_Content += displaySubHits(skill_RUN_GIANT_GROWTH,1)
			if(((SkillSearch(skill_TH_DOUBLE_ATTACK) && (n_A_WeaponType == weapTyp_DAGGER)) || EquipNumSearch( 1296 ) || CardNumSearch(43)))
			{
		...
		myInnerHtml( "CRInum", Max((n_A_CRI - (Max(n_B[en_LUK],0))*5),1) + SubName[0][Language], 0 );
	}
	else
	{
	...
	str_bSUB = "";
	//Double Attack
	if((SkillSearch(skill_TH_DOUBLE_ATTACK) && (n_A_WeaponType == weapTyp_DAGGER)) && n_A_ActiveSkill == skill_ALL_BASIC_ATTACK)
	{
	...
	//Auto Blitz Beat
	if(SkillSearch(skill_HU_BLITZ_BEAT) && n_A_ActiveSkill == skill_ALL_BASIC_ATTACK)
	{
		str_bSUBname += "Auto Blitz Beat <BR>";
		str_bSUB += displaySubHits(skill_HU_BLITZ_BEAT,0)
	}
	//Auto Warg Strike
	if(SkillSearch(skill_RAN_WARG_STRIKE) && n_A_ActiveSkill == skill_ALL_BASIC_ATTACK)
	{
...
function displaySubHits(autosSkill,isCrit)
{
	let textStr = "";
	let numHits = 0;
	let tempDMG = getFinalDamage(getBaseDamage(isCrit),Skill[autosSkill],SkillSearch(autosSkill),isCrit);
	...
	if(numHits > 0 )
	{
		if ( tempDMG[0] === tempDMG[2] )
			textStr += tempDMG[1] + "<BR>(" + (tempDMG[1] / numHits) + " x " + numHits + " hits)<BR>";
		else
			textStr += tempDMG[0] + " ~ " + tempDMG[2] + "<BR>(" + (tempDMG[0] / numHits) + " ~ " + (tempDMG[2] / numHits) + " x " + numHits + " hits)<BR>";
	}
	else
	{
		if ( tempDMG[0] === tempDMG[2] )
			textStr += tempDMG[1] + "<BR>";
		else
			textStr += tempDMG[0] + " ~ " + tempDMG[2] + "<BR>";
	}
	return textStr;
}
